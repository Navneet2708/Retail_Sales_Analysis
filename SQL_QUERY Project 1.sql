...
SELECT COUNT(category) as category from retail_sales;

---- How many unique category we have?
SELECT COUNT(Distinct category) as unique_category from retail_sales;

---- Name the unique Category we have?
SELECT DISTINCT category from retail_sales;


---- Data Analysis & Business Key Problems & Answers:

--Q1: Write a SQL query to retrieve all coulumns for sales made on 2022-11-05?
SELECT *
FROM retail_sales
